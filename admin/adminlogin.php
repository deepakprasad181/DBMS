...
<body bgcolor="#add8e6">
    <h5><a href="../index.php" style="float: right; margin-right:50px; color:#000000">Back to home</a></h5><br>
    <h1 align='center' style="color: #ffffff;font-size:60px"><b>Admin Login</b></h1>
    <h6 align='center' style="color: #212121;font-weight: bold;font-size:15px">Login as an Admin.</h6>
